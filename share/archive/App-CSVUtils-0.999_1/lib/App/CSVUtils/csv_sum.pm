...
1;
# ABSTRACT: Output a summary row which are arithmetic sum of data rows
...
App::CSVUtils::csv_sum - Output a summary row which are arithmetic sum of data rows

=head1 VERSION

This document describes version 0.999_1 of App::CSVUtils::csv_sum (from Perl distribution App-CSVUtils), released on 2022-12-21.
