...
App::CSVUtils::csv_shuf_rows - Shuffle CSV rows

=head1 VERSION

This document describes version 0.999_1 of App::CSVUtils::csv_shuf_rows (from Perl distribution App-CSVUtils), released on 2022-12-21.
